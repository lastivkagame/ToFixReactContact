            ...
            <ListGroupItem onClick={this.onSelect} className={name}>
                <section class="d-flex flex-direction-column">
                    ...
                    <div class="d-flex flex-column marg-5">
                        ...
                        <h4 className={fb}><img class="img-social" src="https://icons-for-free.com/iconfiles/png/512/color+facebook+icon-1320168272811213233.png">{fb_img}</img> </h4>
                        <h4 className={insta}><img class="img-social" src="https://i.pinimg.com/originals/28/cc/b2/28ccb26da651ad37425371f714d36b5e.png"></img>{insta_img}</h4>
                    </div>
